...
angular.module('continuumAssessmentPlatform.teamselectionqa', ['ngRoute'])

    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/select-qa-team', {
            templateUrl: 'teamselectionqa/team-selection-qa.html',
            controller: 'TeamQASelectionCtrl'
        });
    }])
