        ...
        $scope.init = function () {
            ...
            $scope.allTeams = {
                ...
                'DC': [{'name': 'AIMS'}, {'name': 'Card and Emerging Payments'}, {'name': 'Client Side Framework'},
                    ...
                    {'name': 'Virtual Banking - Front End'}, {'name': 'Virtual Banking - Squad 2'}, {'name': 'Web Online'}],
                ...
                'Infra': [{'name': 'Capacity Management'}, {'name': 'End User Computing'}, {'name': 'Linux'}, {'name': 'Oracle'},
