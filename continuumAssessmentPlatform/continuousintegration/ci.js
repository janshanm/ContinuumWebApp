...
.controller('CICtrl', ['$scope', '$rootScope', function($scope, $rootScope) {
    ...
    var isArtisan = function () {
        return !$scope.traveller1 && !$scope.traveller3 && !$scope.traveller5
            && $scope.artisan1 && $scope.artisan2 && $scope.artisan3;
    };

    var isExpert = function() {
        return !$scope.traveller1 && !$scope.traveller3 && !$scope.traveller4 && !$scope.traveller5
