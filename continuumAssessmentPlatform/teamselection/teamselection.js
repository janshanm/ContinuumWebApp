    ...
    .controller('TeamSelectionCtrl', ['$location', '$scope', '$rootScope', 'RetrieveAssessment', function($location, $scope, $rootScope, RetrieveAssessment) {
        ...
        $scope.init = function () {
            ...
            $scope.allTeams = {
                ...
                'CIB': [ {'name': 'Africa Regions'}, {'name': 'BaNCS & Sec Lending'}, {'name': 'Client & Data Services'},
                    {'name': 'Engineering Transformation'}, {'name': 'Finance IT'}, {'name': 'Financial Messaging'},
                    {'name': 'GMO Confirmations'}, {'name': 'GMO Settlements'}, {'name': 'Intellignet Automation (CIB)'},
                    {'name': 'IPSS Liquidity'}, {'name': 'IPSS Settlements'}, {'name': 'JAS'}, {'name': 'Legacy Payments'},
                    {'name': 'Libra BOP'}, {'name': 'MSDS'}, {'name': 'Payments'}, {'name': 'Platforms (Payments)'},
                    {'name': 'Recons'}, {'name': 'Risk Technology: Cybernetics'}, {'name': 'SWIFT Industry'},
