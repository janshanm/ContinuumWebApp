        ...
        $scope.init = function () {
            ...
            $scope.allTeams = {
                ...
                'Card': [{'name': 'Acquiring - Feature Team'}, {'name': 'Acquiring - Rest of Africa'}, {'name': 'Acquiring - Product'}, {'name': 'Acquiring - Flex'},
                    ...
                    {'name': 'Payment Data'}, {'name': 'Base 24'}, {'name': 'Remittances (Instant Money)'}, {'name': 'Fleet'},
                ...
                'EWT': [{'name': 'Domain Architecture'}, {'name': 'BPM'}, {'name': 'ECM'}, {'name': 'ESB'}, {'name': 'Agile Tools'},
                    ...
                    {'name': 'Mainframe Tools'}, {'name': 'IT Enablement - Microsoft Applications'}, {'name': 'IT Enablement - Serena Business Manager'},
                    {'name': 'Sharepoint'}, {'name': 'Source Code Management'},
