        ...
        $scope.init = function () {
            ...
            $scope.allTeams = {
                'AR': [{'name': 'Account Origination'}, {'name': 'ATM'}, {'name': 'Bancassurance'}, {'name': 'Credit Collections'},
                    ...
                    {'name': 'Digital Security'}, {'name': 'GoldenEye'}, {'name': 'Programme-level'}, {'name': 'Service Digitisation'},
                    {'name': 'Value Exchange'}],
                'Card': [{'name': 'Acquiring - Flex'}, {'name': 'Acquiring - Product'}, {'name': 'Acquiring - Rest of Africa'},
                    ...
                    {'name': 'Issuing - Rest of Africa'}, {'name': 'Card - Programme-level'}, {'name': 'RoA Switch(Sparrow)'},
                    {'name': 'Cash - Acquiring'}, {'name': 'Cash - Production'}, {'name': 'Cash - Regulatory'},
                    {'name': 'FASS/GC/COSS'}, {'name': 'GOSS and Outsourced Production'}, {'name': 'GSS - Programme Level'},
                    {'name': 'Robotic Process Automation'}, {'name': 'Workflow - GOSS'}, {'name': 'Auto-Recons Legacy'},
                    {'name': 'Bulk Payments'}, {'name': 'Emerging Payments'}, {'name': 'IntelliMatch'}, {'name': 'Money Transfers and ACB'},
                    ...
                    {'name': 'Postilion/Base 24 - Squad 3'}, {'name': 'Payments - Programme-level'}, {'name': 'Portfolio-level'},
                    {'name': 'Fleet'}, {'name': 'VAF - Programme-level'}, {'name': 'VAF - Squad 1'}, {'name': 'VAF - Squad 2 with Genesis'}],
                'CF': [{'name': 'ML/TF and Sanctions'}, {'name': 'Compliance - Programme-level'}, {'name': 'Surveillance and Reporting'},
                    {'name': 'Deal Pricing and ALM'}, {'name': 'Econ and Reg Capital - Squad 1'}, {'name': 'Econ and Reg Capital - Squad 2'},
                    {'name': 'Finance Central - Squad 1'}, {'name': 'Finance Central - Squad 2'}, {'name': 'Finance Re-engineering'},
                    {'name': 'Procurement'}, {'name': 'Finance - Programme-level'}, {'name': 'Move Management'},
                    {'name': 'Physical Security'}, {'name': 'GRES/GPS - Programme-level'}, {'name': 'Real Estate Projects'},
                    {'name': 'HC Enablement'}, {'name': 'HC - Programme-level'}, {'name': 'HC SAP'},
                    {'name': 'Marketing and Communications'}, {'name': 'Marketing - Programme-level'}, {'name': 'Portfolio-level'},
                    {'name': 'GFCC'}, {'name': 'Risk - Programme-level'}, {'name': 'IOR'}],
                'DS': [{'name': 'AML DevOps'}, {'name': 'Analytics and Third Party'}, {'name': 'Big Data'},
                    ...
                    {'name': 'Human Capital'}, {'name': 'Data Services - Programme-level'}, {'name': 'RDM, MDM and MRI'},
                    {'name': 'Reporting Services'}, {'name': 'Rest of Africa'}, {'name': 'SAP HANA Services (Hybris)'},
                    {'name': 'Wealth'}, {'name': 'Portfolio-level'}],
                'DC': [{'name': 'Card, Digital Payments and Loyalty'}, {'name': 'Client Side Framework'}, {'name': 'Customer Foundation'},
                    ...
                    {'name': 'Personal and SE - Account Management'}, {'name': 'Personal and SE - Transactional and VAS'}, {'name': 'Digital Channel - Programme-level'},
                    {'name': 'Staff Foundation'}, {'name': 'Virtual Banking - Squad 1'}, {'name': 'Virtual Banking - Squad 2'},
                    {'name': 'Web Presence and Community'}, {'name': 'Portfolio-level'}, {'name': 'Experience Design Studio - Programme-level'}],
