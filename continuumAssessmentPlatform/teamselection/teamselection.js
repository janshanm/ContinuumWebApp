    ...
    .controller('TeamSelectionCtrl', ['$location', '$scope', '$rootScope', 'RetrieveAssessment', function($location, $scope, $rootScope, RetrieveAssessment) {
        ...
        $scope.init = function () {
            ...
            $scope.allTeams = {
                ...
                'CIB': [{'name': 'Finance IT'}, {'name': 'MSDS'}, {'name': 'Risk Technology: Cybernetics'}],
                ...
                'DS': [{'name': 'AML DevOps'}, {'name': 'Analytics and Third Party'}, {'name': 'Big Data'},
                    ...
                    {'name': 'Wealth'}],
                'DC': [{'name': 'Forex'}, {'name': 'Corporate Banking'},{'name': 'Card and Emerging Payments'}, {'name': 'Client Side Framework'}, {'name': 'Customer Foundation'},
                ...
                'Infra': [{'name': 'Capacity Management'}, {'name': 'Linux'}, {'name': 'Sybase and DB2'}, {'name': 'SQL'}],
